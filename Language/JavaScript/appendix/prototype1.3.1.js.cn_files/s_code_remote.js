...
Add java.net to internal domains
*/
...
// var s_account="sunjnet"
 var s_account="sunjnetdev"

var s_dynamicAccountSelection=true
var s_dynamicAccountList="sunjnet,sunglobal=java.net;sunjnetdev=."
...
/* s_pageName assignment */
var s_pageName=window.location.host+window.location.pathname
	
/* jsessionid stripper */
s_pageName=s_pageName.replace(/;jsessionid=[0-9a-fA-F]*/,'');
...
var s_linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,doc,pdf,xls,bin,tar,Z,gz,jnlp,jar"
